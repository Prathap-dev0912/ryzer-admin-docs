          ...
          example: `{
 {
    ...
    "message": "Assets fetched successfully"
      ...
      },
      {
        ...
        method: "GET",
        path: "/api/assets/real-estate/asset-overview?assetId=69565b76d9ab739bcfc59ca9",
        ...
        request: {
          ...
          example: `{
  GET /api/assets/real-estate/asset-overview?assetId=69565b76d9ab739bcfc59ca9 HTTP/1
}`,
        },
        response: {
          description: "Returns updated asset object",
          example: `{
  {
    "success": true,
    ...
    "data": {
        ...
        "currency": "QAR",
        "name": "The Pearl Seaview Residences",
        "about": "The Pearl Seaview Residences is a premium residential development located in Porto Arabia at The Pearl-Qatar, Doha’s most prestigious waterfront community.\n The property comprises elegantly designed 1-, 2-, and 3-bedroom apartments featuring modern layouts, European kitchens, marble flooring, and large balconies with sea and marina views.\n Residents benefit from direct promenade access, landscaped podium gardens, temperature-controlled swimming pools, gymnasium, children’s play areas, and 24/7 security.\n The asset is 10 minutes from West Bay CBD, 15 minutes from Katara Cultural Village, and 25 minutes from Hamad International Airport, ensuring consistent demand from expatriates and high-income residents.",
        "country": "QA",
        "state": "DA",
        "city": "Doha",
        "landmark": "The Pearl-Qatar — Porto Arabia Waterfront",
        "latitude": 25.36936187186949,
        "longitude": 51.55307645411048,
        "totalNumberOfSfts": 15000,
        "pricePerSft": 500,
        "basePropertyValue": 7500000,
        "totalPropertyValueAfterFees": 7950000,
        "rentalInformation": {
            "rentPerSqft": 15,
            "vacancyRate": 0,
            "grossMonthlyRent": 225000,
            "netMonthlyRent": 225000,
            "grossAnnualRent": 2700000,
            "netAnnualRent": 2700000,
            "expenses": {
                "monthlyExpenses": 0,
                "annualExpenses": 0
            },
        ...
        "tokenInformation": {
            "tokenSymbol": "PEARL0606",
            "tokenSupply": 15000,
            "minimumTokensToBuy": 1,
            "maximumTokensToBuy": 15000,
            "availableTokensToBuy": 14984,
            "tokenPrice": 500,
            "blockchainProjectAddress": "0xCc0c96b686FEf7236101E176275b6d4bA69df680",
            "blockchainEscrowAddress": "0xe02A37247145191A9D5fAef336a4972381Bc6b0a",
            "blockchainOrderManagerAddress": "0x281DC447cb02d9D71ec5F2E1cC4AcFF66b6c55B3",
            "blockchainDaoAddress": "0x7a718A7375811dF88E44E820f2278888C81D46Eb"
        },
        "hostedBy": {
            "name": "PearlGate Real Estate Development WLL",
            "address": "Marina Commercial Tower, Lusail, Qatar",
            "phone": "55842771",
            "email": "info@pearlgate.qa",
            "website": "http://www.pearlgate.qa",
            "logoUrl": "https://storage.googleapis.com/ryzer-v2/assets/69565b76d9ab739bcfc59ca9/9c0daad2-920d-42a2-b401-460a4e775486.png",
            "whatsappNumber": "55842771",
            "totalProjects": 5,
            "ongoingProjects": 2,
            "primeLocation": "Qatar, Doha",
            "about": "PearlGate Real Estate Development is a Qatar-based developer focused on premium waterfront residential and mixed-use assets in Lusail, West Bay, and The Pearl-Qatar.",
            "yearEstablished": null,
            "isVerified": false
        },
        "annualRentalYield": 33.9622641509434,
        "company": {
            "id": "695650a4d9ab739bcfc59446",
            "name": "Pearl Horizon Property SPV",
            "daoConfiguration": {
                "daoName": "Pearl Horizon",
                "tokenSymbol": "PE_DAO",
                "blockchain": "xdc",
                "governanceModel": "equal-voting",
                "proposalThresholdPercent": 22,
                "quorumPercent": 20,
                "votingPeriod": {
                    "days": 10,
                    "hours": 4
        ...
        "investmentStats": {
            "totalRaised": 624.0443375703414,
            "numberOfInvestors": 3,
            "averageInvestment": 208.0147791901138
        },
        "orderStats": {
            "totalOrders": 3,
            "completedOrders": 0,
      ...
      },
      {
        ...
        method: "GET",
        path: "/api/user/investor/asset-investors?assetId=69565b76d9ab739bcfc59ca9&page=1&limit=10&search=&type=",
        description: "Update an existing asset record",
        parameters: [
          {
            name: "id",
        ...
        request: {
          description: "Update asset details",
          example: `{
GET /api/user/investor/asset-investors?assetId=69565b76d9ab739bcfc59ca9&page=1&limit=10&search=&type=
}`,
        },
        response: {
          description: "Returns updated asset object",
    ...
    "data": [
        {
            ...
            "tokensBooked": 12,
            "totalOrderValue": 70.53915524437285,
            "currency": "QAR",
        ...
        },
        {
            ...
            "tokensBooked": 4,
            "totalOrderValue": 23.50518232596865,
            "currency": "QAR",
